...
BUILD_NAME=gcc8 nix-shell --run ./build-gcc.sh gcc8.nix
gcc8_code="$?"

#BUILD_NAME=gcc9 nix-shell --run ./build-gcc.sh gcc9.nix 
#gcc9_code="$?"
#
#BUILD_NAME=gcc10 nix-shell --run ./build-gcc.sh gcc10.nix 
#gcc10_code="$?"
#
#BUILD_NAME=gcc11 nix-shell --run ./build-gcc.sh gcc11.nix 
#gcc11_code="$?"
#
#BUILD_NAME=gcc12 nix-shell --run ./build-gcc.sh gcc12.nix 
#gcc12_code="$?"
#
#BUILD_NAME=clang8 nix-shell --run ./build-clang.sh clang8.nix 
#clang8_code="$?"
#
#BUILD_NAME=clang9 nix-shell --run ./build-clang.sh clang9.nix 
#clang9_code="$?"
#
#BUILD_NAME=clang10 nix-shell --run ./build-clang.sh clang10.nix 
#clang10_code="$?"
#
#BUILD_NAME=clang11 nix-shell --run ./build-clang.sh clang11.nix 
#clang11_code="$?"
#
#BUILD_NAME=clang12 nix-shell --run ./build-clang.sh clang12.nix 
#clang12_code="$?"
#
#BUILD_NAME=clang13 nix-shell --run ./build-clang.sh clang13.nix 
#clang13_code="$?"
#
#BUILD_NAME=clang14 nix-shell --run ./build-clang.sh clang14.nix
#clang14_code="$?"

zip -r "${LOG_DIR}/*${KK_YEAR}_${KK_MONTH}_${KK_DAY}*.log" "/tmp/${KK_YEAR}_${KK_MONTH}_${KK_DAY}.zip"
